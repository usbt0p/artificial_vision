...
class DispNet(nn.Module):
    ...
    def forward(self, imgL: torch.Tensor, imgR: torch.Tensor,
        ...
        pr6_up = F.interpolate(pr6, scale_factor=2, mode="bilinear",
                               align_corners=False)
        ...
        pr5_up = F.interpolate(pr5, scale_factor=2, mode="bilinear",
                               align_corners=False)
        ...
        pr4_up = F.interpolate(pr4, scale_factor=2, mode="bilinear",
                               align_corners=False)
        ...
        pr3_up = F.interpolate(pr3, scale_factor=2, mode="bilinear",
                               align_corners=False)
        ...
        pr2_up = F.interpolate(pr2, scale_factor=2, mode="bilinear",
                               align_corners=False)
        ...
        pr1_up = F.interpolate(pr1, scale_factor=2, mode="bilinear",
                               align_corners=False)
...
def run_dispnet_inference(
    ...
    disp_color_full = cv2.resize(disp_color, (W_orig, H_orig),
...
def main():
    ...
    # ----- Train mode -----
    p_train = subparsers.add_parser("train", help="Train DispNet on synthetic stereo data")
    ...
    p_train.add_argument("--no_multiscale", action="store_true",
    ...
    p_infer.add_argument("--output", type=str, default="dispnet_pred.png",
